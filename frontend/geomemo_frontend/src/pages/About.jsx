        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              GeoMemo is a location-based note-taking app that allows users to create, 
              store, and manage memos tied to specific geographic locations. Whether 
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                <li>Create memos with titles, descriptions, and optional images</li>
